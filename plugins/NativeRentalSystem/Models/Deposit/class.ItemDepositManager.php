...
class ItemDepositManager implements iDepositManager
{
    protected $conf 	                = NULL;
    protected $lang 		            = NULL;
	...
	public function __construct(ExtensionConfiguration &$paramConf, Language &$paramLang, $paramSettings, $paramItemId)
	{
        // Set class settings
        $this->conf = $paramConf;
	...
	public function getAmount()
	{
		...
		if($this->depositEnabled)
		{
			...
			if(!is_null($row))
			{
				// Use different deposits for each item (unless 0 was passed, than it will return default here)
