...
class LocationType extends AbstractElement implements iPrimitive
{
    private $conf 	                = NULL;
    private $lang 		            = NULL;
    private $debugMode 	            = 0;
    ...
    /**
     * Creating a function to create our location post type
     * @param $paramSlug
    ...
    public function register($paramSlug, $paramMenuPosition)
    {
        ...
        $labels = array(
            'name'                => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_NAME_TEXT'),
            'singular_name'       => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_SINGULAR_NAME_TEXT'),
            'menu_name'           => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_MENU_NAME_TEXT'),
            'parent_item_colon'   => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_PARENT_LOCATION_COLON_TEXT'),
            'all_items'           => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_ALL_LOCATIONS_TEXT'),
            'view_item'           => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_VIEW_LOCATION_TEXT'),
            'add_new_item'        => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_ADD_NEW_LOCATION_TEXT'),
            'add_new'             => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_ADD_NEW_TEXT'),
            'edit_item'           => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_EDIT_LOCATION_TEXT'),
            'update_item'         => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_UPDATE_LOCATION_TEXT'),
            'search_items'        => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_SEARCH_LOCATIONS_TEXT'),
            'not_found'           => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_NOT_FOUND_TEXT'),
            'not_found_in_trash'  => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_LABEL_NOT_FOUND_IN_TRASH_TEXT'),
        );

        // Set other options for Custom Post Type
        $args = array(
            'description'         => $this->lang->getText('NRS_ADMIN_LOCATION_POST_TYPE_DESCRIPTION_TEXT'),
            'labels'              => $labels,
