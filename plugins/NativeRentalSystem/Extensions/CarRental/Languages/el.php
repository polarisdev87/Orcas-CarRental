 ...
 * @Email - tsapournias.alex@gmail.com
 * @Website - http://codecanyon.net/user/alex_tsap
 */
// Settings
$lang['LTR'] = FALSE;
$lang['NRS_RECAPTCHA_LANG'] = 'el';

// Roles
$lang['NRS_PARTNER_ROLE_NAME_TEXT'] = 'Εταιρικός Συνεργάτης';
$lang['NRS_ASSISTANT_ROLE_NAME_TEXT'] = 'Βοηθός Αυτοκινήτου';
$lang['NRS_MANAGER_ROLE_NAME_TEXT'] = 'Διαχειριστής Αυτοκινήτων';
...
// Admin - Global
$lang['NRS_ADMIN_VIEW_DETAILS_TEXT'] = 'Εμφάνισε Πληροφορίες';
$lang['NRS_ADMIN_VIEW_BOOKINGS_TEXT'] = 'Εμφάνισε τις Κρατήσεις';
$lang['NRS_ADMIN_VIEW_UNPAID_BOOKINGS_TEXT'] = 'Εμφάνισε απλήρωτες Κρατήσεις';
$lang['NRS_ADMIN_NO_BOOKINGS_YET_TEXT'] = 'Καμία κράτηση ακόμα';
$lang['NRS_ADMIN_BOOKING_DETAILS_TEXT'] = 'Πληροφορίες Κράτησης';
$lang['NRS_ADMIN_CUSTOMER_DETAILS_FROM_DB_TEXT'] = 'Πληροφορίες Πελάτη (Τελευταία Έκδοση στη βάση δεδομένων)';
$lang['NRS_ADMIN_BOOKING_STATUS_TEXT'] = 'Κατάσταση Κράτησης';
$lang['NRS_ADMIN_BOOKING_STATUS_UPCOMING_TEXT'] = 'Σε εξέλιξη';
$lang['NRS_ADMIN_BOOKING_STATUS_DEPARTED_TEXT'] = 'Αναχώρηση';
$lang['NRS_ADMIN_BOOKING_STATUS_COMPLETED_EARLY_TEXT'] = 'Πρόωρη Ολοκλήρωση';
$lang['NRS_ADMIN_BOOKING_STATUS_COMPLETED_TEXT'] = 'Ολοκληρώθηκε';
$lang['NRS_ADMIN_BOOKING_STATUS_ACTIVE_TEXT'] = 'Ενεργή';
$lang['NRS_ADMIN_BOOKING_STATUS_CANCELLED_TEXT'] = 'Ακυρωμένη';
$lang['NRS_ADMIN_BOOKING_STATUS_PAID_TEXT'] = 'Πληρωμένη';
$lang['NRS_ADMIN_BOOKING_STATUS_UNPAID_TEXT'] = 'Απλήρωτη';
$lang['NRS_ADMIN_BOOKING_STATUS_REFUNDED_TEXT'] = 'Επιστροφή Χρημάτων';
$lang['NRS_ADMIN_PRINT_INVOICE_TEXT'] = 'Εκτύπωση Τιμολογίου';
$lang['NRS_ADMIN_BACK_TO_CUSTOMER_BOOKING_LIST_TEXT'] = 'Επιστροφή στη&#39;s λίστα Κρατήσεις Πελατών';
...
$lang['NRS_ADMIN_UPCOMING_TEXT'] = 'Σε εξέλιξη';
$lang['NRS_ADMIN_PAST_TEXT'] = 'Past';
$lang['NRS_ADMIN_CUSTOMER_BOOKINGS_TEXT'] = 'Κρατήσεις Πελατών';
$lang['NRS_ADMIN_BOOKINGS_BY_TEXT'] = 'Κρατήσεις από %s';
$lang['NRS_ADMIN_ALL_BOOKINGS_TEXT'] = 'Όλες οι κρατήσεις';
$lang['NRS_ADMIN_ALL_PICKUPS_TEXT'] = 'Όλες οι παραλαβές';
$lang['NRS_ADMIN_ALL_RETURNS_TEXT'] = 'Όλες οι παραδόσεις';
...
$lang['NRS_ADMIN_ITEM_PRICES_TEXT'] = 'Τιμές αυτοκινήτων';
...
$lang['NRS_ADMIN_REGULAR_PRICE_TEXT'] = ' Κανονική τιμή';
$lang['NRS_ADMIN_PRICE_TYPE_TEXT'] = 'Τύπος Τιμή';
...
$lang['NRS_ADMIN_CALENDAR_NO_CALENDARS_FOUND_TEXT'] = 'Δεν βρέθηκαν αποτελέσματα για το επιλεγμένο εύρος ημερομηνιών';
$lang['NRS_ADMIN_CHOOSE_PAGE_TEXT'] = ' - Επιλογή σελίδας - ';
$lang['NRS_ADMIN_SELECT_EMAIL_TYPE_TEXT'] = '--- Επιλέξτε τύπο E-mail ---';
...
// Admin Menu
$lang['NRS_ADMIN_MENU_EXTENSION_PAGE_TITLE_TEXT'] = 'Διαχείρηση ενοικιάσεων αυτοκινήτων';
$lang['NRS_ADMIN_MENU_EXTENSION_LABEL_TEXT'] = 'Ενοικιάσεις αυτοκινήτων';
$lang['NRS_ADMIN_MENU_SYSTEM_UPDATE_TEXT'] = 'Αναβάθμιση Συστήματος';
$lang['NRS_ADMIN_MENU_NETWORK_UPDATE_TEXT'] = 'Αναβάθμιση Δικτύου';
// Admin Menu - Benefit Manager
$lang['NRS_ADMIN_MENU_BENEFIT_MANAGER_TEXT'] = 'Benefit Manager';
$lang['NRS_ADMIN_MENU_ADD_EDIT_BENEFIT_TEXT'] = 'Προσθήκη / Edit Benefit';
// Admin Menu - Item Manager
$lang['NRS_ADMIN_MENU_ITEM_MANAGER_TEXT'] = 'Car Manager';
$lang['NRS_ADMIN_MENU_ADD_EDIT_ITEM_TEXT'] = 'Προσθήκη / Επεξεργασία Αυτοκινήτου';
$lang['NRS_ADMIN_MENU_ADD_EDIT_MANUFACTURER_TEXT'] = 'Προσθήκη / Επεξεργασία κατασκευαστή';
$lang['NRS_ADMIN_MENU_ADD_EDIT_BODY_TYPE_TEXT'] = 'Προσθήκη / Επεξεργασία Body Type';
$lang['NRS_ADMIN_MENU_ADD_EDIT_FUEL_TYPE_TEXT'] = 'Προσθήκη / Επεξεργασία Fuel Type';
$lang['NRS_ADMIN_MENU_ADD_EDIT_TRANSMISSION_TYPE_TEXT'] = 'Προσθήκη / Επεξεργασία Transmission Type';
$lang['NRS_ADMIN_MENU_ADD_EDIT_FEATURE_TEXT'] = 'Προσθήκη / Επεξεργασία Feature';
$lang['NRS_ADMIN_MENU_ADD_EDIT_ITEM_OPTION_TEXT'] = 'Προσθήκη / Επεξεργασία Car Option';
$lang['NRS_ADMIN_MENU_BLOCK_ITEM_TEXT'] = 'Block Car';
// Admin Menu - Item Prices
$lang['NRS_ADMIN_MENU_ITEM_PRICES_TEXT'] = 'Τιμές αυτοκινητων';
$lang['NRS_ADMIN_MENU_ADD_EDIT_PRICE_GROUP_TEXT'] = 'Προσθήκη / Επεξεργασία Price Group';
$lang['NRS_ADMIN_MENU_ADD_EDIT_PRICE_PLAN_TEXT'] = 'Προσθήκη / Επεξεργασία Car Price Plan';
$lang['NRS_ADMIN_MENU_ADD_EDIT_ITEM_DISCOUNT_TEXT'] = 'Προσθήκη / Επεξεργασία Car Discount';
// Admin Menu - Extras Manager
$lang['NRS_ADMIN_MENU_EXTRAS_MANAGER_TEXT'] = 'Extras Manager';
$lang['NRS_ADMIN_MENU_ADD_EDIT_EXTRA_TEXT'] = 'Προσθήκη / Επεξεργασία Extra';
$lang['NRS_ADMIN_MENU_ADD_EDIT_EXTRA_OPTION_TEXT'] = 'Προσθήκη / Επεξεργασία Extra Option';
$lang['NRS_ADMIN_MENU_ADD_EDIT_EXTRA_DISCOUNT_TEXT'] = 'Προσθήκη / Επεξεργασία Extra Discount';
...
$lang['NRS_ADMIN_MENU_ADD_EDIT_LOCATION_TEXT'] = 'Προσθήκη / Επεξεργασία Location';
$lang['NRS_ADMIN_MENU_ADD_EDIT_DISTANCE_TEXT'] = 'Προσθήκη / Επεξεργασία Distance';
...
$lang['NRS_ADMIN_MENU_ADD_EDIT_CUSTOMER_TEXT'] = 'Προσθήκη/Επεξεργασία Customer';
$lang['NRS_ADMIN_MENU_ADD_EDIT_BOOKING_TEXT'] = 'Προσθήκη/Επεξεργασία Reservation';
...
$lang['NRS_ADMIN_MENU_ADD_EDIT_PAYMENT_METHOD_TEXT'] = 'Προσθήκη / Επεξεργασία Payment Method';
$lang['NRS_ADMIN_MENU_ADD_EDIT_PREPAYMENT_TEXT'] = 'Προσθήκη / Επεξεργασία Prepayment';
$lang['NRS_ADMIN_MENU_ADD_EDIT_TAX_TEXT'] = 'Προσθήκη / Επεξεργασία Tax';
// Admin Menu - Settings
$lang['NRS_ADMIN_MENU_SINGLE_MANAGER_TEXT'] = 'Settings';
$lang['NRS_ADMIN_MENU_ADD_EDIT_GLOBAL_SETTINGS_TEXT'] = 'Προσθήκη / Επεξεργασία Global Settings';
$lang['NRS_ADMIN_MENU_ADD_EDIT_CUSTOMER_SETTINGS_TEXT'] = 'Προσθήκη / Επεξεργασία Customer Settings';
$lang['NRS_ADMIN_MENU_ADD_EDIT_SEARCH_SETTINGS_TEXT'] = 'Προσθήκη / Επεξεργασία Search Settings';
$lang['NRS_ADMIN_MENU_ADD_EDIT_PRICE_SETTINGS_TEXT'] = 'Προσθήκη / Επεξεργασία Price Settings';
$lang['NRS_ADMIN_MENU_ADD_EDIT_EMAIL_TEXT'] = 'Προσθήκη / Επεξεργασία Email';
...
$lang['NRS_ADMIN_MENU_INSTRUCTIONS_TEXT'] = 'Οδηγίες';
// Admin Menu - Network Manager
$lang['NRS_ADMIN_MENU_NETWORK_MANAGER_TEXT'] = 'Διαχειριστής δικτύου';
...
// Admin Core
$lang['NRS_ADMIN_EDIT_TEXT'] = 'Επεξεργασία';
$lang['NRS_ADMIN_DELETE_TEXT'] = 'Διαγραφή';
$lang['NRS_ADMIN_CANCEL_TEXT'] = 'Ακύρωση';
$lang['NRS_ADMIN_UNBLOCK_TEXT'] = 'Ξεμπλοκάρισμα';
$lang['NRS_ADMIN_MARK_PAID_TEXT'] = 'Σήμανση ως πληρωμένο';
$lang['NRS_ADMIN_MARK_COMPLETED_EARLY_TEXT'] = 'Mark Completed Early';
$lang['NRS_ADMIN_REFUND_TEXT'] = 'Επιστροφή πληρωμής';
$lang['NRS_ADMIN_SELECT_LOCATION_TEXT'] = '-- Επιλέξτε τοποθεσία --';
$lang['NRS_ADMIN_ALL_LOCATIONS_TEXT'] = 'οποιοδήποτε κατάστημα ';
$lang['NRS_ADMIN_AVAILABLE_TEXT'] = 'Available';
$lang['NRS_ADMIN_DISPLAYED_TEXT'] = 'Displayed';
$lang['NRS_ADMIN_VISIBLE_TEXT'] = 'Ορατό';
$lang['NRS_ADMIN_HIDDEN_TEXT'] = 'Κρυφό';
$lang['NRS_ADMIN_ENABLED_TEXT'] = 'Διαθέσιμο';
$lang['NRS_ADMIN_DISABLED_TEXT'] = 'Απενεργοποιημένο';
$lang['NRS_ADMIN_ALLOWED_TEXT'] = 'Επιτρέπεται';
$lang['NRS_ADMIN_FAILED_TEXT'] = 'Απέτυχε';
...
$lang['NRS_ADMIN_YES_TEXT'] = 'Ναι';
$lang['NRS_ADMIN_NO_TEXT'] = 'Οχι';
$lang['NRS_ADMIN_DAILY_TEXT'] = 'Καθημερινά';
$lang['NRS_ADMIN_HOURLY_TEXT'] = 'Ωριαία';
$lang['NRS_ADMIN_PER_BOOKING_TEXT'] = 'Per Reservation';
$lang['NRS_ADMIN_COMBINED_TEXT'] = 'σε συνδυασμό  - Ημερομίσθιου &amp; ωρομίσθιου';
$lang['NRS_ADMIN_NEVER_TEXT'] = 'Ποτέ';
...
$lang['NRS_PER_DAY_TEXT'] = 'Μέρα';
$lang['NRS_PER_HOUR_TEXT'] = 'ώρα';
$lang['NRS_SELECT_DATE_TEXT'] = 'Ημέρομηνία';
$lang['NRS_SELECT_YEAR_TEXT'] = 'Χρόνος';
$lang['NRS_SELECT_MONTH_TEXT'] = 'Μήνας';
$lang['NRS_SELECT_DAY_TEXT'] = 'Ημέρα';
$lang['NRS_PRICE_TEXT'] = 'Τιμή';
$lang['NRS_PERIOD_TEXT'] = 'Περίοδος';
$lang['NRS_DURATION_TEXT'] = 'Διάρκεια';
$lang['NRS_MON_TEXT'] = 'Δευτ';
$lang['NRS_TUE_TEXT'] = 'Τριτ';
$lang['NRS_WED_TEXT'] = 'Τετ';
$lang['NRS_THU_TEXT'] = 'Πεμπ';
$lang['NRS_FRI_TEXT'] = 'Παρ';
$lang['NRS_SAT_TEXT'] = 'Σαβ';
$lang['NRS_SUN_TEXT'] = 'Κυρ';
$lang['NRS_LUNCH_TEXT'] = 'Lunch';
$lang['NRS_MONDAYS_TEXT'] = 'Δευτέρες';
$lang['NRS_TUESDAYS_TEXT'] = 'Τρίτες';
$lang['NRS_WEDNESDAYS_TEXT'] = 'Τετάρτες';
$lang['NRS_THURSDAYS_TEXT'] = 'Πέμπτες';
$lang['NRS_FRIDAYS_TEXT'] = 'Παρασκεύες';
$lang['NRS_SATURDAYS_TEXT'] = 'Σάββατα';
$lang['NRS_SUNDAYS_TEXT'] = 'Κυριακές';
$lang['NRS_LUNCH_TIME_TEXT'] = 'Lunch Time';
$lang['NRS_ALL_YEAR_TEXT'] = 'All Year';
$lang['NRS_ALL_DAY_TEXT'] = '24 ΩΡΕΣ';
$lang['NRS_PARTIAL_DAY_TEXT'] = '%s - 12:00 AM';
$lang['NRS_MIDNIGHT_TEXT'] = '00:00';
$lang['NRS_NOON_TEXT'] = '12:00';
$lang['NRS_CLOSED_TEXT'] = 'Κλειστά';
$lang['NRS_OPEN_TEXT'] = 'Ανοιχτά';
$lang['NRS_TODAY_TEXT'] = 'Today';
$lang['NRS_DATE_TEXT'] = 'Ημερομηνία';
$lang['NRS_TIME_TEXT'] = 'Ώρα';
$lang['NRS_DAYS_TEXT'] = 'days';
$lang['NRS_DAYS2_TEXT'] = 'Ημέρες';
$lang['NRS_DAY_TEXT'] = 'ημέρα';
$lang['NRS_HOURS_TEXT'] = 'ώρα';
$lang['NRS_HOURS2_TEXT'] = 'ώρες';
$lang['NRS_HOUR_TEXT'] = 'ώρα';
$lang['NRS_MINUTES_TEXT'] = 'Λεπτά';
$lang['NRS_MINUTES2_TEXT'] = 'λεπτά';
$lang['NRS_MINUTE_TEXT'] = 'λεπτό';
$lang['NRS_DAILY_TEXT'] = 'καθημερινά';
$lang['NRS_HOURLY_TEXT'] = 'ωριαία';
...
$lang['NRS_UNCLASSIFIED_ITEM_TYPE_TEXT'] = 'Άλλο';
$lang['NRS_NO_ITEMS_AVAILABLE_TEXT'] = 'Κανένα Αμάξι διαθέσιμο';
$lang['NRS_NO_ITEMS_AVAILABLE_IN_THIS_CLASS_TEXT'] = 'Κανένα αμάξι διαθέσιμο σε αυτή την κατηγορία';
$lang['NRS_NO_EXTRAS_AVAILABLE_TEXT'] = 'Κανένα extras διαθέσιμο';
...
$lang['NRS_NONE_TEXT'] = 'Τίποτα';
$lang['NRS_NOT_SET_TEXT'] = 'Not set';
$lang['NRS_DO_NOT_EXIST_TEXT'] = 'Δεν υπάρχει';
$lang['NRS_EXIST_TEXT'] = 'Υπάρχει';
$lang['NRS_NOT_REQ_TEXT'] = 'Not req.';
$lang['NRS_REQ_TEXT'] = 'Req.';
$lang['NRS_NOT_REQUIRED_TEXT'] = 'Δεν απαιτείται';
$lang['NRS_REQUIRED_TEXT'] = 'απαιτείται';
$lang['NRS_DONT_DISPLAY_TEXT'] = 'Don&#39;t display';
$lang['NRS_WITH_TAX_TEXT'] = 'με Φόρο';
$lang['NRS_WITHOUT_TAX_TEXT'] = 'w/o Φόρος';
$lang['NRS_TAX_TEXT'] = 'Φόρος';
$lang['NRS_FROM_TEXT'] = 'Από';
$lang['NRS_TO_TEXT'] = 'σε';
$lang['NRS_ALL_TEXT'] = 'All';
$lang['NRS_OR_TEXT'] = 'ή';
$lang['NRS_AND_TEXT'] = 'και';
$lang['NRS_UNLIMITED_TEXT'] = 'Χωρίς Όρια';
$lang['NRS_DEPOSIT_TEXT'] = 'Κατάθεση';
$lang['NRS_DISCOUNT_TEXT'] = 'Έκπτωση';
$lang['NRS_PREPAYMENT_TEXT'] = 'Ποσό προπληρωμής';
$lang['NRS_TOTAL_TEXT'] = 'Συνολικά';
$lang['NRS_BACK_TEXT'] = 'Πίσω';
$lang['NRS_CONTINUE_TEXT'] = 'Συνέχεια';
$lang['NRS_SEARCH_TEXT'] = 'Αναζήτηση';
$lang['NRS_SELECT_DROPDOWN_TEXT'] = '--- Επιλογή ---';
$lang['NRS_ITEM_TEXT'] = 'Αυτοκίνητο';
$lang['NRS_EXTRA_TEXT'] = 'Εξτρα';
$lang['NRS_RENTAL_OPTION_TEXT'] = 'Επιλογή Ενοικίασης';
$lang['NRS_ITEMS_TEXT'] = 'Αυτοκίνητα';
$lang['NRS_EXTRAS_TEXT'] = 'Εξτρας';
$lang['NRS_RENTAL_OPTIONS_TEXT'] = 'Επιλογές Ενοικίασης';
$lang['NRS_SHOW_ITEM_TEXT'] = 'Εμφάνισε Αυτοκίνητο';
$lang['NRS_VIA_PARTNER_TEXT'] = 'via %s';
$lang['NRS_COUPON_TEXT'] = 'Κουπόνι';

// Booking step no. 1 - item search
$lang['NRS_BOOKING_TEXT'] = 'Κράτηση';
$lang['NRS_PICKUP_TEXT'] = 'Τόπος Παραλαβής';
$lang['NRS_RETURN_TEXT'] = 'Τόπος Επιστροφής';
$lang['NRS_OTHER_TEXT'] = 'Επιπλέον ';
$lang['NRS_INFORMATION_TEXT'] = 'Πληροφορίες Αυτοκινήτων';
$lang['NRS_CITY_AND_LOCATION_TEXT'] = 'Πόλη &amp; Τοποθεσία:';
$lang['NRS_PICKUP_CITY_AND_LOCATION_TEXT'] = 'Τόπος Παραλαβής Πόλη &amp; Τοποθεσία:';
$lang['NRS_RETURN_CITY_AND_LOCATION_TEXT'] = 'Τόπος Επιστροφής Πόλη &amp; Τοποθεσία:';
$lang['NRS_SELECT_BOOKING_DATE_TEXT'] = 'Ημερομηνία:';
$lang['NRS_SELECT_BOOKING_PERIOD_TEXT'] = 'Περίοδος κράτησης:';
$lang['NRS_COUPON_CODE_TEXT'] = 'Κωδικός Κουπονιού';
$lang['NRS_I_HAVE_BOOKING_CODE_TEXT'] = 'Νούμερο Κράτησης:';
$lang['NRS_I_HAVE_COUPON_CODE_TEXT'] = 'Έχω ένα κουπόνι(κουπόνι):';
$lang['NRS_PICKUP_LOCATION_TEXT'] = 'Τόπος Παραλαβής';
$lang['NRS_RETURN_LOCATION_TEXT'] = 'Τόπος Επιστροφής';
$lang['NRS_ALL_BODY_TYPES_DROPDOWN_TEXT'] = '---- All Types ----';
$lang['NRS_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT'] = '---- All Transmissions ----';
$lang['NRS_SELECT_PICKUP_LOCATION_TEXT'] = '-- Επιλέξτε Τόπο Παραλαβής --';
$lang['NRS_SELECT_RETURN_LOCATION_TEXT'] = '-- Επιλέξτε Τόπο Επιστροφής --';
$lang['NRS_PICKUP_DATE_TEXT'] = 'Ημερομηνία Παραλαβής';
$lang['NRS_RETURN_DATE_TEXT'] = 'Ημερομηνία Παράδοσης';
$lang['NRS_PICKUP_DATE_ALERT_TEXT'] = 'Παρακαλώ επιλέξτε ημερομηνία παραλαβής!';
$lang['NRS_RETURN_DATE_ALERT_TEXT'] = 'Παρακαλώ επιλέξτε ημερομηνία παράδοσης!';
$lang['NRS_BOOKING_PERIOD_ALERT_TEXT'] = 'Παρακαλώ επιλέξτε περίοδο κράτησης!';
$lang['NRS_PICKUP_LOCATION_ALERT_TEXT'] = 'Παρακαλώ επιλέξτε τοποθεσία παραλαβής!';
$lang['NRS_RETURN_LOCATION_ALERT_TEXT'] = 'Παρακαλώ επιλέξτε τοποθεσία παράδοσης!';
$lang['NRS_COUPON_CODE_ALERT_TEXT'] = 'Παρακαλώ εισάγετε κωδικό κουπονιού';
$lang['NRS_SHOW_ITEM_DESCRIPTION_TEXT'] = 'Εμφάνιση περιγραφή αυτοκινήτου ';
$lang['NRS_UPDATE_BOOKING_TEXT'] = 'Ενημέρωση Κρατησή μου';
$lang['NRS_CANCEL_BOOKING_TEXT'] = 'Ακύρωση κράτησης';
$lang['NRS_CHANGE_BOOKING_DATE_TIME_AND_LOCATION_TEXT'] = 'Αλλαγή Ημερομηνίας, ώρας &amp; τοποθεσίας';
$lang['NRS_CHANGE_BOOKED_ITEMS_TEXT'] = 'Αλλαγή αυτοκινήτων';
$lang['NRS_CHANGE_EXTRAS_TEXT'] = 'Αλλαγή Extras';
$lang['NRS_CHANGE_RENTAL_OPTIONS_TEXT'] = 'Αλλαγή Επιλογών Ενοικίασης ';
$lang['NRS_IN_THIS_LOCATION_TEXT'] = 'Σε αυτόν τον κλάδο';
$lang['NRS_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT'] = 'Δεν επιτρέπετε';
$lang['NRS_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT'] = 'Δεν επιτρέπετε';

// Booking step no. 2 - search results
$lang['NRS_DISTANCE_AWAY_TEXT'] = '%s away';
$lang['NRS_BOOKING_DATA_TEXT'] = 'Στοιχεία Κράτησης';
$lang['NRS_BOOKING_CODE_TEXT'] = 'Κωδικός Κράτησης';
$lang['NRS_BOOKING_EDIT_TEXT'] = 'Επεξεργασία';
$lang['NRS_BOOKING_PICKUP_TEXT'] = 'Παραλαβή';
$lang['NRS_BOOKING_BUSINESS_HOURS_TEXT'] = 'Εργάσιμες ώρες';
$lang['NRS_BOOKING_FEE_TEXT'] = 'Τέλη';
$lang['NRS_BOOKING_RETURN_TEXT'] = 'Επιστροφή';
$lang['NRS_BOOKING_NIGHTLY_RATE_TEXT'] = 'μετά από ώρες';
$lang['NRS_BOOKING_AFTERHOURS_TEXT'] = 'μετά από ώρες';
$lang['NRS_BOOKING_EARLY_TEXT'] = 'Early';
$lang['NRS_BOOKING_LATE_TEXT'] = 'Late';
$lang['NRS_BOOKING_AFTERHOURS_PICKUP_TEXT'] = 'Παραλαβή μετά απο καθορισμένες ώρες';
$lang['NRS_BOOKING_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT'] = 'Μη εφικτό';
$lang['NRS_BOOKING_AFTERHOURS_RETURN_TEXT'] = 'Παράδοση μετά απο καθορισμένες ώρες';
$lang['NRS_BOOKING_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT'] = 'Μη εφικτό';
$lang['NRS_CHOOSE_TEXT'] = 'Επιλέξτε';
$lang['NRS_SEARCH_RESULTS_TEXT'] = 'Αποτελέσματα Αναζήτησης';
$lang['NRS_MILEAGE_TEXT'] = 'Απόσταση σε Μίλια';

// Booking step no. 3 - booking options
$lang['NRS_SELECT_RENTAL_OPTIONS_TEXT'] = 'Επιλέξτε Επιλογές Ενοικίασης';
$lang['NRS_SELECTED_ITEMS_TEXT'] = 'Επιλεγμένα αυτοκίνητα';
$lang['NRS_FOR_DEPENDANT_ITEM_TEXT'] = ' (for %s)';
$lang['NRS_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT'] = 'Δεν διατίθενται έξτρα αυτοκινήτων. Κάντε κλικ στο κουμπί συνέχεια';

// Booking step no. 4 - booking details
$lang['NRS_PICKUP_DATE_AND_TIME_TEXT'] = 'Παραλαβή ημερομηνία &amp; χρόνος';
$lang['NRS_RETURN_DATE_AND_TIME_TEXT'] = 'Παράδοση ημερομηνία &amp; χρόνος';
$lang['NRS_UNIT_PRICE_TEXT'] = 'Τιμή μονάδας';
$lang['NRS_QUANTITY_TEXT'] = 'Ποσότητα';
$lang['NRS_QUANTITY_SHORT_TEXT'] = 'ποσοτ.';
$lang['NRS_PICKUP_FEE_TEXT'] = 'Τέλη παραλαβής';
$lang['NRS_RETURN_FEE_TEXT'] = 'Τέλη παράδοσης';
$lang['NRS_NIGHTLY_PICKUP_RATE_APPLIED_TEXT'] = '(Εφαρμογή νυχτερινού φόρου)';
$lang['NRS_NIGHTLY_RETURN_RATE_APPLIED_TEXT'] = '(Εφαρμογή νυχτερινού φόρου)';
$lang['NRS_ITEM_QUANTITY_SUFFIX_TEXT'] = 'αυτοκίνητο/α';
$lang['NRS_EXTRA_QUANTITY_SUFFIX_TEXT'] = 'έξτρα/ς';
$lang['NRS_PAY_NOW_OR_AT_PICKUP_TEXT'] = 'Πληρωμή τώρα/ κατά την Παραλαβή';
$lang['NRS_PAY_NOW_TEXT'] = 'Πληρωμή τώρα';
$lang['NRS_PAY_AT_PICKUP_TEXT'] = 'Πληρωμή κατα την παραλαβή';
$lang['NRS_PAY_LATER_OR_ON_RETURN_TEXT'] = 'Πληρωμή αργότερα / στην Επιστροφή';
$lang['NRS_PAY_LATER_TEXT'] = 'Πληρωμή αργότερα';
$lang['NRS_PAY_ON_RETURN_TEXT'] = 'Πληρωμή στην Επιστροφή';
$lang['NRS_ITEM_RENTAL_DETAILS_TEXT'] = 'Λεπτομέρειες Ενοικίασης';
$lang['NRS_MANUFACTURER_TEXT'] = 'Κατασκευαστής';
$lang['NRS_ITEM_MODEL_TEXT'] = 'Μοντέλο Αυτοκινήτου';
$lang['NRS_GROSS_TOTAL_TEXT'] = ' Μερικό σύνολο';
$lang['NRS_GRAND_TOTAL_TEXT'] = 'Σύνολο';
$lang['NRS_BOOKING_DETAILS_TEXT'] = 'Λεπτομέρειες Κράτησης';
$lang['NRS_CUSTOMER_DETAILS_TEXT'] = 'Λεπτομέρειες πελάτη ';
$lang['NRS_EXISTING_CUSTOMER_DETAILS_TEXT'] = 'Αναζήτηση για Υπάρχων Στοιχεία Πελάτη ';
$lang['NRS_EXISTING_CUSTOMER_TEXT'] = 'Υπάρχων πελάτης';
$lang['NRS_EMAIL_ADDRESS_TEXT'] = 'Διέυθυνση e-mail';
$lang['NRS_FETCH_CUSTOMER_DETAILS_TEXT'] = 'Λήψη Λεπτομερειών';
$lang['NRS_OR_ENTER_NEW_DETAILS_TEXT'] = 'Ή να δημιουργήστε ένα νέο λογαριασμό ';
$lang['NRS_CUSTOMER_TEXT'] = 'Πελάτης';
$lang['NRS_TITLE_TEXT'] = 'Τίτλος';
$lang['NRS_MR_TEXT'] = 'Κύριος';
$lang['NRS_MS_TEXT'] = 'Κυρία';
$lang['NRS_MRS_TEXT'] = 'Κυρία.';
$lang['NRS_MISS_TEXT'] = 'δεσποινίδα.';
$lang['NRS_DR_TEXT'] = 'Δρ.';
$lang['NRS_PROF_TEXT'] = 'Καθηγ.';
$lang['NRS_FIRST_NAME_TEXT'] = 'Όνομα';
$lang['NRS_LAST_NAME_TEXT'] = 'Επώνυμο';
$lang['NRS_DATE_OF_BIRTH_TEXT'] = 'Ημερομηνία γέννησης';
$lang['NRS_YEAR_OF_BIRTH_TEXT'] = 'Χρονολογία γέννησης';
$lang['NRS_ADDRESS_TEXT'] = 'διέυθυνση';
$lang['NRS_STREET_ADDRESS_TEXT'] = 'διέυθυνση';
$lang['NRS_CITY_TEXT'] = 'Πόλη';
$lang['NRS_STATE_TEXT'] = 'Πολιτεία';
$lang['NRS_ZIP_CODE_TEXT'] = 'Ταχυδρομικός κώδικας';
$lang['NRS_COUNTRY_TEXT'] = 'Χώρα';
$lang['NRS_PHONE_TEXT'] = 'Τηλέφωνο';
$lang['NRS_EMAIL_TEXT'] = 'Email';
$lang['NRS_ADDITIONAL_COMMENTS_TEXT'] = 'Επιπλέον Σχόλια';
$lang['NRS_CUSTOMER_ID_TEXT'] = 'ID Πελάτη';
$lang['NRS_IP_ADDRESS_TEXT'] = 'IP Address';
$lang['NRS_PAY_BY_SHORT_TEXT'] = 'Πληρώστε με';
$lang['NRS_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT'] = 'Αποδέχομαι τους όρους χρήσης';
$lang['NRS_TERMS_AND_CONDITIONS_TEXT'] = 'όροι χρήσης';
$lang['NRS_CONFIRM_TEXT'] = 'Επιβεβαίωση';
$lang['NRS_FIELD_REQUIRED_TEXT'] = 'Αυτό το πεδίο είναι υποχρεωτικό';

// Booking step no. 5 - process booking
$lang['NRS_PAYMENT_DETAILS_TEXT'] = 'Λεπτομέρειες πληρωμής';
$lang['NRS_PAYMENT_OPTION_TEXT'] = 'Πληρωμή με';
$lang['NRS_PAYER_EMAIL_TEXT'] = 'Πληρωτής E-Mail';
$lang['NRS_TRANSACTION_ID_TEXT'] = 'Ταυτότητα συναλλαγής';
$lang['NRS_PROCESSING_PAYMENT_TEXT'] = 'επεξεργασία πληρωμής...';
$lang['NRS_PLEASE_WAIT_UNTIL_PAYMENT_WILL_BE_PROCESSED_TEXT'] = 'Παρακαλώ περιμένετε, επεξεργαζόμαστε την παραγγελία σας...';

//display-booking-confirm.php
$lang['NRS_STEP5_PAY_ONLINE_TEXT'] = 'Online Πληρωμή';
$lang['NRS_STEP5_PAY_AT_PICKUP_TEXT'] = 'Πληρωμή κατα την παραλαβή';
$lang['NRS_THANK_YOU_TEXT'] = 'Ευχαριστούμε!';
$lang['NRS_YOUR_BOOKING_CONFIRMED_TEXT'] = 'Η κρατησή σας καταχωρύθηκε. Κωδικός Κράτησης ';
$lang['NRS_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT'] = 'Τιμολόγιο αποστέλλεται στην ηλεκτρονική σας διεύθυνση ';

//display-booking-failure.php
$lang['NRS_BOOKING_FAILURE_TEXT'] = 'Η κράτηση απέτυχε';
$lang['NRS_BOOKING_FAILURE_SEARCH_ALL_ITEMS_TEXT'] = 'Αναζήτηση όλων των αυτοκινήτων';

// display-item-price-table.php
$lang['NRS_DAY_PRICE_TEXT'] = 'Ημερομίσθιο';
$lang['NRS_HOUR_PRICE_TEXT'] = 'Ωρομίσθιο';
$lang['NRS_NO_ITEMS_IN_THIS_CATEGORY_TEXT'] = 'Δεν υπάρχουν αυτοκίνητα σε αυτή την κατηγορία';
$lang['NRS_PRICE_FOR_DAY_FROM_TEXT'] = 'Το ημερομίσθιο ξεκινάει από';
$lang['NRS_PRICE_FOR_HOUR_FROM_TEXT'] = 'Το ωρομίσθιο ξεκινάει από';
$lang['NRS_PRICE_WITH_APPLIED_TEXT'] = 'με εφαρμογή';
$lang['NRS_WITH_APPLIED_DISCOUNT_TEXT'] = 'Έκπτωση';

// class.ItemsAvailability.php
$lang['NRS_MONTH_DAY_TEXT'] = 'Ημέρα';
$lang['NRS_MONTH_DAYS_TEXT'] = 'Days';
$lang['NRS_ITEMS_AVAILABILITY_FOR_TEXT'] = 'Διαθέσιμα αυτοκίνητα';
$lang['NRS_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT'] = 'Διαθέσιμα αυτοκίνητα για τις επόμενες 30 μέρες';
$lang['NRS_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT'] = 'Partial Cars Availability For';
$lang['NRS_ITEMS_AVAILABILITY_THIS_MONTH_TEXT'] = 'Διαθέσιμα αυτοκίνητα αυτό το μήνα'; // Not used
$lang['NRS_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT'] = 'Διαθέσιμα αυτοκίνητα τον επόμενο μήνα'; // Not used
$lang['NRS_ITEM_ID_TEXT'] = 'ID:';
$lang['NRS_TOTAL_ITEMS_TEXT'] = 'Συνολικά αυτοκίνητα:';

// class.ExtrasAvailability.php
$lang['NRS_EXTRAS_AVAILABILITY_FOR_TEXT'] = 'Διαθέσιμα έξτρας για';
$lang['NRS_EXTRAS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT'] = 'Διαθέσιμα έξτρας για τις επόμενες 30 μέρες';
$lang['NRS_EXTRAS_PARTIAL_AVAILABILITY_FOR_TEXT'] = 'Partial Extras Availability For';
$lang['NRS_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT'] = 'Διαθέσιμα έξτρας για αυτό τον μήνα'; // Not used
$lang['NRS_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT'] = 'Διαθέσιμα έξτρας για τον επόμενο μήνα'; // Not used
$lang['NRS_EXTRA_ID_TEXT'] = 'ID';
$lang['NRS_TOTAL_EXTRAS_TEXT'] = 'Συνολικά έξτρας:';

// class.ItemsController.php
$lang['NRS_SHOW_ITEM_PAGE_TEXT'] = 'Εμφάνιση περιγραφής αυτοκινήτου';
$lang['NRS_PARTNER_TEXT'] = 'Συνεργάτης';
$lang['NRS_BODY_TYPE_TEXT'] = 'Κατηγορία';
$lang['NRS_TRANSMISSION_TYPE_TEXT'] = 'κιβώτιο ταχυτήτων';
$lang['NRS_FUEL_TYPE_TEXT'] = 'καύσιμα';
$lang['NRS_ITEM_FUEL_CONSUMPTION_TEXT'] = 'κατανάλωση καυσίμου';
$lang['NRS_ITEM_PASSENGERS_TEXT'] = 'Συνολικοί επιβάτες';
$lang['NRS_ITEM_PRICE_FROM_TEXT'] = 'Τιμή από';
$lang['NRS_INQUIRE_TEXT'] = 'Call';
$lang['NRS_GET_A_QUOTE_TEXT'] = 'Ζητήστε μας προσφορά';
$lang['NRS_ITEM_FEATURES_TEXT'] = ' Χαρακτηριστικά';
$lang['NRS_BOOK_ITEM_TEXT'] = 'Κράτηση';

// class.LocationsController.php
$lang['NRS_LOCATIONS_BUSINESS_HOURS_TEXT'] = 'Business Hours';
$lang['NRS_LOCATION_FEES_TEXT'] = 'Τέλη Τοποθεσίας';
...
$lang['NRS_ITEM_ENGINE_CAPACITY_TEXT'] = 'κυβισμός';
$lang['NRS_ITEM_LUGGAGE_TEXT'] = 'Συνολικές βαλίτσες';
$lang['NRS_ITEM_DOORS_TEXT'] = 'Πόρτες';
$lang['NRS_ITEM_DRIVER_AGE_TEXT'] = 'Ελάχιστη ηλικία πελάτη';
$lang['NRS_ADDITIONAL_INFORMATION_TEXT'] = 'Επιπλέον πληροφορίες';
...
$lang['NRS_CANCELLED_SUCCESSFULLY_TEXT'] = 'ακυρώθηκε με επιτυχία';
$lang['NRS_NOT_CANCELLED_TEXT'] = 'Η Κράτηση δεν ακυρώθηκε';

// template.Step8EditBooking.php
$lang['NRS_EDIT_TEXT'] = 'Αλλαγή';
$lang['NRS_BOOKING2_TEXT'] = 'κράτηση';
$lang['NRS_EDIT_BOOKING_BUTTON_TEXT'] = 'Αλλαγή κράτησης';
$lang['NRS_EDIT_BOOKING_PLEASE_ENTER_BOOKING_NUMBER_TEXT'] = 'Παρακαλώ εισάγετε τον αριθμό κράτησης!';
...
// Install Element
$lang['NRS_INSTALL_DEFAULT_COMPANY_NAME_TEXT'] = 'Εταιρία ενοικιάσεων αυτοκινήτων';
...
$lang['NRS_INSTALL_DEFAULT_CANCELLED_PAYMENT_PAGE_TITLE_TEXT'] = 'Ακύρωση Πληρωμής';
$lang['NRS_INSTALL_DEFAULT_CANCELLED_PAYMENT_PAGE_CONTENT_TEXT'] = 'Η πληρωμή σας ακυρώθηκε. Η κράτηση σας δεν έχει επιβεβαιωθεί.';
$lang['NRS_INSTALL_DEFAULT_CONFIRMATION_PAGE_TITLE_TEXT'] = 'Επιβεβαίωση Κράτησης';
$lang['NRS_INSTALL_DEFAULT_CONFIRMATION_PAGE_CONTENT_TEXT'] = 'Ευχαριστούμε. Δεχτήκαμε την πληρωμή σας. Η κράτηση σας  Επιβεβαιώθηκε.';
$lang['NRS_INSTALL_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT'] = 'Όροι Χρήσης για τις ενοικιάσεις αυτοκινήτων';
...
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_PAYPAL_DESCRIPTION_TEXT'] = 'Ασφαλή Άμεση Πληρωμή';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_STRIPE_TEXT'] = 'Πιστωτική Κάρτα (μέσω Stripe.com)';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_BANK_TEXT'] = 'Μεταφορά Τραπέζης';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_BANK_DETAILS_TEXT'] = 'Λεπτομέρειες Τραπέζης';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_PAY_OVER_THE_PHONE_TEXT'] = 'ΠΛηρώστε μέσω τηλεφώνου';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_PAY_ON_ARRIVAL_TEXT'] = 'Πληρώστε κατα την παραλαβή';
$lang['NRS_INSTALL_DEFAULT_PAYMENT_METHOD_PAY_ON_ARRIVAL_DETAILS_TEXT'] = 'Χρειάζεται πιστωτική κάρτα';
$lang['NRS_INSTALL_DEFAULT_DEAR_TEXT'] = 'Αγαπητέ';
$lang['NRS_INSTALL_DEFAULT_REGARDS_TEXT'] = 'Εκτίμηση';
$lang['NRS_INSTALL_DEFAULT_EMAIL_TITLE_BOOKING_DETAILS_TEXT'] = 'Πληροφορίες Κράτησης - no. [BOOKING_CODE]';
$lang['NRS_INSTALL_DEFAULT_EMAIL_TITLE_BOOKING_CONFIRMED_TEXT'] = 'Κράτηση Νουμ. [BOOKING_CODE] - Επιβαιβεώθηκε';
$lang['NRS_INSTALL_DEFAULT_EMAIL_TITLE_BOOKING_CANCELLED_TEXT'] = 'Κράτηση Νουμ. [BOOKING_CODE] - Ακυρώθηκε';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_TITLE_BOOKING_DETAILS_TEXT'] = 'Ειδοποίηση: Καινούργια Κράτηση - [BOOKING_CODE]';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_TITLE_BOOKING_CONFIRMED_TEXT'] = 'Ειδοποίηση: Κράτηση Πληρώθηκε - [BOOKING_CODE]';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_TITLE_BOOKING_CANCELLED_TEXT'] = 'Ειδοποίηση: Κράτηση Ακυρώθηκε - [BOOKING_CODE]';
$lang['NRS_INSTALL_DEFAULT_EMAIL_BODY_BOOKING_RECEIVED_TEXT'] = 'Οι πληροφορίες κρατησής σας ελήφθησαν';
$lang['NRS_INSTALL_DEFAULT_EMAIL_BODY_BOOKING_DETAILS_TEXT'] = 'Πληροφορίες Κράτησης:';
$lang['NRS_INSTALL_DEFAULT_EMAIL_BODY_PAYMENT_RECEIVED_TEXT'] = 'Η πληρωμή σας λήφθηκε. Η κράτηση σας επιβαιβεώθηκε';
$lang['NRS_INSTALL_DEFAULT_EMAIL_BODY_BOOKING_CANCELLED_TEXT'] = 'Η κρατησή σας  no. [BOOKING_CODE] ακυρώθηκε.';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_BODY_BOOKING_RECEIVED_TEXT'] = 'Η κρατησή σας   no. [BOOKING_CODE] Λήφθηκε απο [CUSTOMER_NAME].';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_BODY_BOOKING_DETAILS_TEXT'] = 'Πληροφορίες Κράτησης:';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_BODY_BOOKING_PAID_TEXT'] = 'Η κράτηση σας  no. [BOOKING_CODE] πρόσφατα πληρώθηκε από [CUSTOMER_NAME].';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_BODY_BOOKING_CANCELLED_TEXT'] = 'Η κράτηση σας no. [BOOKING_CODE] για [CUSTOMER_NAME] πρόσφατα ακυρώθηκε.';
$lang['NRS_INSTALL_DEFAULT_NOTIFICATION_EMAIL_BODY_CANCELLED_BOOKING_DETAILS_TEXT'] = 'Πληροφορίες Κράτησης, η οποία ακυρώθηκε:';
