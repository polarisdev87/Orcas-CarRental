...
ga('ec:addProduct', {               // Provide product details in an productFieldObject.
    ...
    'price': '<?php print($extra['unit']['discounted_total_with_tax']); ?>',// Product price (currency).
    'coupon': '<?php print($couponCode); ?>',                               // Product coupon (string).
...
ga('ec:setAction', 'purchase', {          // Transaction details are provided in an actionFieldObject.
    'id': '<?php print($bookingCode); ?>',                                  // (Required) Transaction id (string).
    'affiliation': '<?php print($extensionName); ?>',                       // Affiliation (string).
    'revenue': '<?php print($priceSummary['overall']['grand_total']); ?>',  // Revenue, including all taxes (currency).
    'tax': '<?php print($priceSummary['overall']['total_tax']); ?>',        // Tax (currency).
    'coupon': '<?php print($couponCode); ?>'                                // Transaction coupon (string).
});
...
ga('send', 'event', '<?php print($extensionName.' Enhanced Ecommerce'); ?>', 'Purchase', {'nonInteraction': true});
</script>