...
<form action="<?php print($blockFormAction); ?>" method="post" class="block-form">
    <table cellpadding="0" cellspacing="7" border="0" align="left" style="width: 100%; text-align:left;">
        <tr>
            ...
            <td>
                <input type="text" name="start_date" value="<?php print($startDate); ?>" class="start-date" style="width:90px" readonly="readonly" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="end_date" value="<?php print($endDate); ?>" class="end-date" style="width:90px" readonly="readonly"/>
        ...
        <tr>
            <td></td>
            <td><input type="submit" name="search_to_block" value="Search for Extras to Block" style="cursor:pointer; min-width: 209px;"/></td>
        </tr>
    </table>
</form>
<script type="text/javascript">
