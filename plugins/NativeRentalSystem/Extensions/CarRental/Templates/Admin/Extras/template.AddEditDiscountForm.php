...
<div id="container-inside" style="width:1000px;">
    ...
    <input type="button" value="Back To Extras Discount List" onClick="window.location.href='<?php print($backToListURL); ?>'" style="background: #EFEFEF; float:right; cursor:pointer;"/>
    ...
    <table cellpadding="5" cellspacing="2" border="0">
        ...
        <tr>
            <td width="20%"><strong>Select an Extra:</strong></td>
            <td width="80%">
                <input type="hidden" name="price_plan_id" value="0" />
                <select name="extra_id" class="">
                    <?php print($extrasDropDownOptions); ?>
                </select> (optional, leave blank to apply same discount % to all extras)
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>Price Discount:</strong><br /><em>(of total extra&#39;s price)</em></td>
            <td>
