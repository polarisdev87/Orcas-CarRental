...
?>
<h1>
    <span>Car Discount Plans for Reservation in Advance</span>&nbsp;&nbsp;
...
<table class="display advance-datatable" border="0" style="width:100%">
    ...
    <tr>
        <th>#</th>
        <th>Reservation Before - Until / Price Group &amp; Plan</th>
        <th>Discount (%) Of Total Car Price</th>
        <th>Actions</th>
    </tr>
    </thead>
    <tbody><?php print($adminBookingInAdvanceDiscountGroups); ?></tbody>
</table>
<p>
