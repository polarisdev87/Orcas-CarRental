...
<div class="car-rental-list-admin calendar-search-results car-rental-tabbed-admin car-rental-tabbed-admin-wide bg-cyan">
	<div class="body">
		...
		<div class="car-rental-admin-tabs car-rental-admin-tabs-pos-top-left car-rental-admin-tabs-anim-flip car-rental-admin-tabs-response-to-icons">
			...
			<label for="car-rental-admin-tab1"><span><span><i class="fa fa-car"></i>Available Cars</span></span></label>
			<ul>
				<li class="car-rental-admin-tab-content-1">
					<div class="typography">
						...
						<div class="col-search">
							<input class="back-to" type="button" value="Back to This Month Car Calendar"
								onClick="window.location.href='admin.php?page=<?php print($objConf->getURLPrefix()); ?>booking-manager&tab=items-calendar'"
								/>
						</div>
						<?php foreach($arrItemsCalendars AS $itemsCalendar): ?>
							<?php
							if($classifiedItems):
							...
							?>
						<?php endforeach; ?>
						<?php if(sizeof($arrItemsCalendars) == 0): ?>
