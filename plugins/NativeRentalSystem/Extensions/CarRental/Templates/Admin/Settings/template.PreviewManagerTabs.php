...
?>
<div class="car-rental-preview-admin car-rental-tabbed-admin car-rental-tabbed-admin-medium car-rental-tabbed-admin bg-cyan">
	<?php if ($errorMessage != ""): ?>
	...
	<div class="body">
		...
		<div class="car-rental-admin-tabs car-rental-admin-tabs-pos-top-left car-rental-admin-tabs-anim-flip car-rental-admin-tabs-response-to-icons">
			<input type="radio" name="car-rental-admin-tabs"<?php print($emailPreviewTabChecked); ?> id="car-rental-admin-tab1" class="car-rental-admin-tab-content-1">
			<label for="car-rental-admin-tab1"><span><span><i class="fa fa-bolt"></i>Email Content Preview</span></span></label>

			<ul>
				<li class="car-rental-admin-tab-content-1">
					<div class="typography">
						<?php include('partial.EmailPreview.php'); ?>
					</div>
				</li>
			</ul>
		</div>
