...
final class ExtrasAvailabilitySearchResultsController extends AbstractController
{
    ...
    public function getContent()
    {
        ...
        for($localMonthDiff = 0; $localMonthDiff <= $localTotalMonths; $localMonthDiff++)
        {
            ...
            $arrExtrasCalendars[] = $objExtrasCalendar->getMonthlyCalendar(-1, -1, -1, -1, -1, -1, -1, -1, -1, $localSelectedYear, $localSelectedMonth);
        }
        // Calendar table: End
        ...
        $this->view->arrExtrasCalendars = $arrExtrasCalendars;

        // Get the template
        $retContent = $this->getTemplate('Booking', 'ExtrasAvailabilitySearchResults', 'Tabs');
